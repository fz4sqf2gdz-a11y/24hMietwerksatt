...
2. In `assets/main.js` ganz oben die ID eintragen:
...
Alle Events werden in `assets/main.js` zentral über die Funktion `track()` gesendet. Die Zuordnung passiert über `data-`Attribute im HTML – kein Event ist fest verdrahtet.
